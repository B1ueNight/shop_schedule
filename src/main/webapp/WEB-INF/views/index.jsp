...
<body>
    <div class="date">
        ...
        <button id="shopping">쇼핑 기록 로그 파일 생성</button>
        <button id="review">리뷰 기록 로그 파일 생성</button>
        <button id="member">회원 조회 로그 파일 생성</button>
        <button id="product">제품 조회 로그 파일 생성</button>
    </div>
</body>
</html>